    ...
    <div className='flex  h-28  items-center justify-between p-4' >
      <div className="flex flex-col ">
        <div className="flex flex-row items-center ">
          ...
          <input type="text" placeholder='What´s happening?' maxLength={350} className={clsx('transition-all text-xlg text-black ml-3 h-6  w-600px p-2 bg-transparent focus:border-b-2 border-dark-5 outline-none ', {
